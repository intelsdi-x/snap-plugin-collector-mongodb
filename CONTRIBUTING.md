...
* Whether your contribution is for a bug fix or a feature request, **create an [Issue](https://github.com/intelsdi-x/snap-plugin-collector-mongodb/issues)** and let us know what you are thinking.
...
$ git clone https://github.com/intelsdi-x/snap-plugin-collector-mongodb.git
    ```
...
If you have questions feel free to contact the [maintainers](https://github.com/intelsdi-x/snap/blob/master/docs/MAINTAINERS.md#snap-maintainers).
